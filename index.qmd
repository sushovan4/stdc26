...
# Finite Reconstruction Problem {background-image="chaya.png" background-opacity="0.03"}
...
# Geometric <green>Reconstruction</green>Theorem {background-image="chaya.png" background-opacity="0.03"}
...
- <green>$\Delta(\mathcal G)$</green>: *Shadow radius* positive number for graphs with smooth edges
...
Let $M\subset\mathbb R^N$ be a knot with reach $\tau(M)$. Let $S\subset M$ be a finite subset and $\beta>0$ a number such that 
$$
\frac{1}{\zeta}d_{\mathrm H}(M,S)<\beta\leq\frac{3(1+2\zeta)(1-14\zeta)}{8(1-2\zeta)^2}\tau(M)
$$ 
for some $0<\zeta<1/14$. Then, the shadow $\mathcal S(\mathcal R_\beta(S))$ is homotopy equivalent to $M$.
...
- <red>Noiseless case</red>: What about $S$ being *near* $M$? 
- <red>General manifolds</red>: What about higher-dimensional manifolds? 

# Future Directions 

- Apex paper *in preparation* with <green>Kazuhiro Kawamura</green> & <green>Atish Mitra</green>
